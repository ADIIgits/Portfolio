      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <h2 className="text-3xl sm:text-5xl font-bold mb-12 flex items-center gap-4">
            <span className="text-white/20 font-mono text-xl sm:text-2xl">01.</span>
            About Me
          </h2>
          
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-8">
              <div className="glass p-8 sm:p-10 rounded-3xl text-lg sm:text-xl text-white/80 leading-relaxed font-light space-y-6">
                {profile.about.split('\n').map((paragraph, idx) => (
            ...
            <div className="lg:col-span-4 space-y-6">
              <div className="glass p-8 rounded-3xl flex flex-col gap-4">
                <div className="text-sm text-white/40 uppercase tracking-widest">Connect</div>
              ...
              {profile.resumeUrl && (
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer"
                  className="glass p-8 rounded-3xl flex items-center justify-between group cursor-pointer hover:bg-white/[0.04] transition-colors"
                >
